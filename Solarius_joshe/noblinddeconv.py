...
DATASET_DIR   = "dataset/data_extra"                   
#FILE_PREFIX   = "chromosphere_100p"         
FILE_PREFIX   = "chromosphere_200p"         
#FILE_PREFIX   = "continuum_200p"         
OUTPUT_DIR    = "output_fits/noblindeconv_extra"        

PERCENTILE_KEEP  = 20           # era 80
UPSAMPLE_FACTOR  = 10           # era 10            

PSF_SIGMA = 1.5                # era 2.0    
BLIND_PSF_SIZE     = 15         # era 15

BLIND_DECONV_ITERS = 20      # era 20 
CONVERGENCE_TOL    = 1e-5       #era 1e-5
